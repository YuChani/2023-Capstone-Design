...
(cl:defmethod cl:initialize-instance :after ((m <CarlaEgoVehicleControl>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CarlaEgoVehicleControl)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name servo_control-msg:<CarlaEgoVehicleControl> is deprecated: use servo_control-msg:CarlaEgoVehicleControl instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <CarlaEgoVehicleControl>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader servo_control-msg:header-val is deprecated.  Use servo_control-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'throttle-val :lambda-list '(m))
(cl:defmethod throttle-val ((m <CarlaEgoVehicleControl>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader servo_control-msg:throttle-val is deprecated.  Use servo_control-msg:throttle instead.")
  (throttle m))

(cl:ensure-generic-function 'steer-val :lambda-list '(m))
(cl:defmethod steer-val ((m <CarlaEgoVehicleControl>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader servo_control-msg:steer-val is deprecated.  Use servo_control-msg:steer instead.")
  (steer m))

(cl:ensure-generic-function 'brake-val :lambda-list '(m))
(cl:defmethod brake-val ((m <CarlaEgoVehicleControl>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader servo_control-msg:brake-val is deprecated.  Use servo_control-msg:brake instead.")
  (brake m))

(cl:ensure-generic-function 'hand_brake-val :lambda-list '(m))
(cl:defmethod hand_brake-val ((m <CarlaEgoVehicleControl>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader servo_control-msg:hand_brake-val is deprecated.  Use servo_control-msg:hand_brake instead.")
  (hand_brake m))

(cl:ensure-generic-function 'reverse-val :lambda-list '(m))
(cl:defmethod reverse-val ((m <CarlaEgoVehicleControl>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader servo_control-msg:reverse-val is deprecated.  Use servo_control-msg:reverse instead.")
  (reverse m))

(cl:ensure-generic-function 'gear-val :lambda-list '(m))
(cl:defmethod gear-val ((m <CarlaEgoVehicleControl>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader servo_control-msg:gear-val is deprecated.  Use servo_control-msg:gear instead.")
  (gear m))
...
(cl:defmethod manual_gear_shift-val ((m <CarlaEgoVehicleControl>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader servo_control-msg:manual_gear_shift-val is deprecated.  Use servo_control-msg:manual_gear_shift instead.")
  (manual_gear_shift m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CarlaEgoVehicleControl>)))
  ...
  "servo_control/CarlaEgoVehicleControl")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CarlaEgoVehicleControl)))
  "Returns string type for a message object of type 'CarlaEgoVehicleControl"
  "servo_control/CarlaEgoVehicleControl")
